...
export const fetchUsers = (paginationParams) => ({ type: types.FETCH_USERS, payload: paginationParams })
export const searchUsers = (paginationParams) => ({ type: types.SEARCH_USERS, payload: paginationParams })

export const createUser = (data) => ({ type: types.CREATE_USER, payload: data })
export const updateUser = (username, data, currentPage) => ({
  type: types.UPDATE_USER,
  payload: { username, data },
  currentPage,
})
export const updateUserPassword = (username, password, currentPage) => ({
  type: types.UPDATE_USER_PASSWORD,
  payload: { username, password },
  currentPage,
})
export const deleteUser = (username, currentPage) => ({ type: types.DELETE_USER, payload: username, currentPage })
