...
const AddEditCinema = ({ type = "create", cinema, currentPage }) => {
  ...
  const handleSubmit = (values) => {
    ...
    if (type === "edit" && cinema?.id) {
      dispatch(updateCinema({ ...payload, id: cinema.id }, currentPage))
    } else {
  ...
  return (
    ...
    >
      <Form form={form} layout="vertical" onFinish={handleSubmit}>
        <Form.Item label="Tên rạp" name="name" rules={[{ required: true, message: "Vui lòng nhập tên rạp!" }]}>
