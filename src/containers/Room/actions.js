...
export const updateRoom = (data, currentPage) => ({ type: types.UPDATE_ROOM, payload: data, currentPage })
export const deleteRoom = (id, currentPage) => ({ type: types.DELETE_ROOM, payload: id, currentPage })
