...
export const updateShowtime = (data, currentPage) => ({ type: types.UPDATE_SHOWTIME, payload: data, currentPage })
export const deleteShowtime = (id, currentPage) => ({ type: types.DELETE_SHOWTIME, payload: id, currentPage })
